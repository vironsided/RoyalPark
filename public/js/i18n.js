...
const translations = {
    ...
    ru: {
        ...
        sales_type_FULL: "Tam ödənişli (полная оплата)",
        sales_type_INSTALLMENT: "Hissəli (в рассрочку)",
        sales_section_header: "Шапка договора",
        sales_section_buyer: "Покупатель (Alıcı)",
        sales_section_property: "Объект (Yaşayış sahəsi)",
        sales_section_installment: "Рассрочка",
        sales_field_contract_number: "№ договора (NN)",
        ...
        sales_field_buyer_id_series: "Ş/V seriya",
        ...
        sales_field_buyer_address: "Ünvan (адрес)",
        ...
        sales_schedule_title: "График платежей (Əlavə №2)",
